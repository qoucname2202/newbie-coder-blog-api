...
/// <summary>
/// Request body for PUT /api/v1/admin/posts/{postId}.
/// </summary>
public sealed class UpdateAdminPostRequest
{
    ...
    /// <summary>
    /// The author ID to reassign the post to.
    /// If null, keeps the current author.
    /// </summary>
